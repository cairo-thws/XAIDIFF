...
from xai.load_utils import load_dataset, load_huggingface_dataset
import wandb
import torchvision

from xai.utils import EarlyStopper
...
DATASET_NAME = args.dataset  # "cats_vs_dogs"
IMAGE_SIZE = 128
IMAGE_CHANNELS = args.imgchannels  # 3
SEED = 1234

UNET_BLOCK_OUT_CHANNELS = [64, 128, 192, 256]  # [128, 256, 512]  # [64, 128, 192, 256]  # [32, 64, 128, 256]


num_inference_steps = num_train_timesteps = 1000
TRAINING_LR = 1e-4
...
# %% Load the data set
# trainset = load_dataset(DATASET_NAME, (IMAGE_SIZE, IMAGE_SIZE))["train"]
...
accelerator = Accelerator(
    ...
    log_with="wandb",
    project_dir="XAIDIFFDDPMTraining",
)
